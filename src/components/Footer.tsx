    ...
    <footer className="relative bg-neutral-950 text-neutral-300 overflow-hidden border-t border-purple-500/30 font-sans">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-12 flex flex-col items-center gap-8 z-10">
        ...
        <div className="flex items-center gap-4">
          {[
            { icon: Youtube, label: "YouTube", hoverColor: "hover:text-red-500 hover:border-red-500/50", href: "https://youtu.be/dQw4w9WgXcQ?si=82HT8lUe8Ykf6IzB" },
            { icon: Github, label: "GitHub", hoverColor: "hover:text-white hover:border-white/50", href: "https://github.com/celestecruzzg" },
          ].map((Social, index) => (
            <a
              key={index}
              href={Social.href}
